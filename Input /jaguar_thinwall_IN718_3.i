...
[DiracKernels]
  [./point_heat_source_raster]
    type = MovingDirac3dHatch_IN718_760_raster
    variable = temperature
    value = 142.5
    point = '0.2 0.506 0.495'
  [../]
  [./point_heat_source_contour1]
    type = MovingDirac3dHatch_IN718_760_contour1
    variable = temperature
    value = 69
    point = '0 0 0'
  [../]
  [./point_heat_source_contour2]
    type = MovingDirac3dHatch_IN718_760_contour2
    variable = temperature
    value = 40
    point = '0 0 0'
  [../]
