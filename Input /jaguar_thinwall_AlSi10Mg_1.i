...
[DiracKernels]
  [./point_heat_source_raster]
    type = MovingDirac3dHatch_AlSi10Mg_500_raster
    variable = temperature
    value = 118.4
    point = '0.2 0.506 0.495'
  [../]
  [./point_heat_source_contour1]
    type = MovingDirac3dHatch_AlSi10Mg_500_contour1
    variable = temperature
    value = 25.6
    point = '0 0 0'
  [../]
  [./point_heat_source_contour2]
    type = MovingDirac3dHatch_AlSi10Mg_500_contour2
    variable = temperature
    value = 27.2
    point = '0 0 0'
  [../]
